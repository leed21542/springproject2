...
insert into person (`id`,`name`,`age`,`blood_type`,`year_of_birthday`,`month_of_birthday`,`day_of_birthday`) values (4,'sophie',7,'AB',1994,8,31);
...
insert into block(`id`,`name`) values (2,'sophie');
